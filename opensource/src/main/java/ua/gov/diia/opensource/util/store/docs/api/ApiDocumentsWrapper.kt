package ua.gov.diia.opensource.util.store.docs.api
...
import ua.gov.diia.opensource.util.extensions.getCorrectDocTypeList
...
class ApiDocumentsWrapper @Inject constructor(
    ...
    private suspend fun loadDocs(map: Map<String, String> = emptyMap()): Docs {
        ...
        return originalDocs.copy(
            documentsTypeOrder = getCorrectDocTypeList(originalDocs.documentsTypeOrder)
        )
    }
