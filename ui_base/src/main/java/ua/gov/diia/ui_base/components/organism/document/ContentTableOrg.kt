...
fun ContentTableOrg(
    ...
    Column(
        ...
        data.tableBlockTwoColumnsOrgData?.let {
...
@Preview
@Composable
fun ContentTableOrgPreview() {
    val heading = HeadingWithSubtitlesMlcData(
        value = "Дія Надія Володимирівна", subtitles = listOf("Diia Nadiia")
    )
    ...
    val tableBlockTwoColumnsOrgData = TableBlockTwoColumnsOrgData(
        id = "123",
        heading = heading,
        photo = base64String,
        items = listOf(
