...
@Composable
fun DocTableItemHorizontalMlc(
    modifier: Modifier = Modifier,
    data: DocTableItemHorizontalMlcData,
...
data class DocTableItemHorizontalMlcData(
...
@Composable
@Preview
fun DocTableItemHorizontalMlcPreview_Minimum() {
    val state = DocTableItemHorizontalMlcData(
        id = "123",
        title = "Title",
        value = "Label Value"
    )
...
@Composable
@Preview
fun DocTableItemHorizontalMlcPreview_SupportText() {
    val state = DocTableItemHorizontalMlcData(
        id = "123",
        title = "Title",
        value = "Label Value",
...
@Composable
@Preview
fun DocTableItemHorizontalMlcPreview_Full() {
    val state = DocTableItemHorizontalMlcData(
        id = "123",
        title = "Title",
...
@Composable
@Preview
fun DocTableItemHorizontalMlcPreview_ValueAsImage() {
    val state = DocTableItemHorizontalMlcData(
        id = "123",
        title = "Title",
        secondaryTitle = "Secondary title",
